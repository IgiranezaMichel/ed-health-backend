...
public class UserController {
    ...
    public User saveUser(@Argument(name = "input") inputUser data) {
        ...
        return userRepo.save(new User(data.getId(), data.getName(), data.getGender(), data.getNationalId(),
                data.getProfilePicture(), data.getPhoneNumber(), data.getEmail(), data.getDob(), data.getRole(),
                BCrypt.hashpw(data.getPassword(), BCrypt.gensalt()), school));
    }
    ...
    @MutationMapping()
    public String addUserRole(@Argument(name = "userEmail") String userEmail, @Argument(name = "role") String role,
            @Argument(name = "domainName") String domainName, @Argument(name = "domainId") long domainId) {
    ...
    @QueryMapping()
    public UserPage useListPagination(@Argument(name = "pageNumber") int pageNumber,
        ...
        return new UserPage(listOfUser.getContent(), listOfUser.getNumber(), listOfUser.getTotalPages(),
